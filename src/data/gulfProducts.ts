...
export const gulfCategories: ProductCategory[] = [
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
    brand: 'Gulf',
    slug: 'mobil'
  },
  {
...
export const gulfProducts: ProductSpec[] = [
  // --- MOBIL (CAR) ---
  {
    ...
    name: 'Gulf Formula',
    slug: 'gulf-formula',
    image: 'https://assets.gulfoilltd.com/apac/files/2022-08/1.%20GF_Banner_568x280%20%282%29.webp?VersionId=QcYO6l8Lnykd.kHoLhOH30ls8pv7gKYA',
    categoryId: 'mobil',
  ...
  },
  {
    ...
    image: 'https://assets.gulfoilltd.com/apac/files/2022-08/1.%20CAR_EO_GUS_Banner_568x280_1%20%281%29.webp?VersionId=jw4LDnf1kJ1NFuqUAb66ZDZZhQwHL3Tb',
    categoryId: 'mobil',
  ...
  },
  {
    ...
    name: 'Gulf MAX',
    slug: 'gulf-max',
    image: 'https://assets.gulfoilltd.com/apac/files/2022-08/1.%20CAR_EO_MAX_Banner_568x280%20%281%29.webp?VersionId=DWIhmS5VHyn1rkoba4M74HEgRuwmQFy5',
    categoryId: 'mobil',
  ...
  // --- MOTORCYCLE ---
  {
    ...
    name: 'Gulf Syntrac',
    slug: 'gulf-syntrac',
    image: 'https://assets.gulfoilltd.com/apac/files/2022-08/mobile.webp?VersionId=V8NSdVH4PZTr8PiAgc4m51da4gWZNKxm',
    categoryId: 'motor',
  ...
  },
  {
    ...
    name: 'Gulf Powertrac',
    slug: 'gulf-powertrac',
    image: 'https://assets.gulfoilltd.com/apac/files/2022-08/1.%20MC_EO_GPOWERTRAC_568x280.webp?VersionId=lXwKpiS2Z.XYG4o2WXzKWSCO8QVT9lz6',
    categoryId: 'motor',
  ...
  },
  {
    ...
    name: 'Gulf Pride',
    slug: 'gulf-pride',
    image: 'https://assets.gulfoilltd.com/apac/files/2022-08/1.%20MC_EO_GPRIDE_568x280.webp?VersionId=qTCJqPgGuuW8arL2yLXYDoE0c6p0ichx',
    categoryId: 'motor',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1611270418597-a6c77f4b7271?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
    categoryId: 'industrial',
  ...
  },
  {
    ...
    name: 'Gulf Crest',
    slug: 'gulf-crest',
    image: 'https://images.unsplash.com/photo-1534398079543-7ae6d016b86a?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
    categoryId: 'industrial',
